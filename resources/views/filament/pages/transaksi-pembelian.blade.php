        ...
        <div class="w-full md:w-1/3">
            <x-filament::input.wrapper>
                ...
                <x-filament::input
                    type="text"
                    disabled
                    placeholder="Cari nomor transaksi atau supplier (Segera Hadir)"
                />
            </x-filament::input.wrapper>
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-800/50 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 font-medium">Supplier</th>
                        ...
                        <td colspan="5" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                                    Modul transaksi pembelian sedang dalam tahap pengembangan (API eksternal). 
                                    Data transaksi pembelian akan ditampilkan di sini setelah integrasi selesai.
                                </p>
                            </div>
                        </td>
                    </tr>
