        ...
        <div style="display: flex; align-items: center; justify-content: space-between; gap: 20px;">
            <div style="flex: 1;">
                <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
                    ...
                    <span
                        style="background-color: #dbeafe; color: #1d4ed8; padding: 2px 8px; border-radius: 4px; font-size: 0.75rem; font-weight: 600; text-transform: uppercase;">
                        {{ auth()->user()->roles()->first()?->name ?? 'User' }}
                    </span>
                </div>

                <p style="color: #6b7280; font-size: 1rem; line-height: 1.5; margin-bottom: 0; max-width: 600px;">
                    Panel Admin siap digunakan. Pantau statistik aset, kelola kategori, lokasi, dan karyawan, serta
                    pastikan sistem berjalan lancar.
                </p>
            </div>
